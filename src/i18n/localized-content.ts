...
const industryNotes = {
  es: {
    Hospitality: "Presencia digital, pedidos y comunicación para bares, lounges y beach clubs.",
    "Fitness & Wellness": "Apps de miembros, horarios y dirección de marca para gimnasios y conceptos de entrenamiento.",
    "Food & Beverage": "Sistemas de pedido y presencia de marca para restaurantes, chefs privados y locales.",
    "Real Estate": "Marca personal y routing de leads para asesores en mercados basados en introducciones.",
    "Fashion & Retail": "Dirección de marca y presencia digital para marcas independientes.",
    "Luxury & Concierge": "Posicionamiento de servicios privados donde la confianza llega antes que el precio.",
    "Legal Services": "Automatización de intake y gestión de consultas. Sin proyecto publicado todavía.",
    "Beauty & Personal Care": "Reservas y comunicación con clientes. Sin proyecto publicado todavía.",
  },
  de: {
    ...
    "Legal Services": "Intake-Automatisierung und Anfragebearbeitung. Noch kein veröffentlichtes Projekt.",
    "Beauty & Personal Care": "Buchungssysteme und Kundenkommunikation. Noch kein veröffentlichtes Projekt.",
  },
} as const;
